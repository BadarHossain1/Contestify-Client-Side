                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <button onClick={handleRegister} className="flex ml-auto text-white bg-gradient-to-r from-indigo-400  to-blue-400 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Register</button>
