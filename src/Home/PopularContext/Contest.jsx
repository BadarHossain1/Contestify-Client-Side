        ...
        <div>
            <div className="w-full max-w-sm  overflow-hidden bg-white rounded-lg shadow-lg mt-4 dark:bg-gray-800">
                ...
                <div className="px-6 py-4 flex-grow">
                    <h1 className="text-xl font-semibold text-gray-800 dark:text-white">Name: {contestName}</h1>

                    <p className="py-2 text-gray-700 dark:text-gray-400">{description}....</p>

                    <div className="flex items-center mt-4 mb-6 text-gray-700 dark:text-gray-200">
