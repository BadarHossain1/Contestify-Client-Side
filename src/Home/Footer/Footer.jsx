                    ...
                    <div className="flex flex-col items-center text-center">
                        <a href="#">
                            <div className="flex justify-center  items-center">
                                ...
                                <Link to='/' className=" font-extrabold text-white  font-EBGaramond text-xl lg:text-3xl">Contestify</Link>
                            </div>
                        </a>

                        <div className="flex flex-wrap justify-center mt-6 -mx-4 text-white">
                            <ul className="flex gap-3"><li><Link to='/' className="text-base">Home</Link></li>
                                <li><Link to='/' className="text-base">All Context</Link></li></ul>
                        </div>
